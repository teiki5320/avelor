...
const DATA: Record<string, SituationData> = {
  'dettes-urssaf': {
    ...
    etapes: [
      { titre: 'Appelez l\'URSSAF avant qu\'ils ne vous appellent', texte: 'Composez le 3957 (service URSSAF, 0,06 €/min + prix d\'un appel) et demandez un échelonnement. Préparez votre dernier bilan et une estimation du montant dû. Un appel proactif est toujours mieux perçu qu\'un silence.' },
