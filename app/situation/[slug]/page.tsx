...
const DATA: Record<string, SituationData> = {
  ...
  'impots-impayes': {
    ...
    loi: 'Le droit de reprise de l\'administration fiscale est de 3 ans pour l\'IR et l\'IS, 4 ans pour la TVA (à partir de l\'année suivant celle au titre de laquelle l\'impôt est dû). Vous pouvez demander un délai de paiement au comptable public (SIE). La CCSF (Commission des Chefs de Services Financiers) permet d\'obtenir un échelonnement global de toutes vos dettes fiscales et sociales en une seule demande. Enfin, une remise gracieuse est possible en cas de gêne ou indigence (article L247 du Livre des procédures fiscales).',
    etapes: [
      { titre: 'Contactez votre SIE immédiatement', texte: 'Le Service des Impôts des Entreprises de votre département est votre interlocuteur direct. Appelez ou écrivez pour demander un délai. Un contribuable qui demande est toujours mieux traité qu\'un contribuable qui se cache.' },
      { titre: 'Saisissez la CCSF', texte: 'Si vous avez à la fois des dettes fiscales et sociales, la CCSF permet de tout regrouper en un seul échéancier. C\'est un guichet unique gratuit.' },
      { titre: 'Demandez une remise gracieuse', texte: 'En cas de difficultés exceptionnelles, vous pouvez demander une réduction totale ou partielle de l\'impôt dû. Ce n\'est pas automatique, mais c\'est un droit.' },
      { titre: 'Vérifiez les prescriptions', texte: 'Avec votre expert-comptable, identifiez les impositions qui pourraient être prescrites (plus de 3 ou 4 ans selon l\'impôt).' },
    ],
